            ...
            <Reveal key={step.step} delay={(i % 4) as 0 | 1 | 2 | 3}>
              <li className="relative lg:pl-16">
                <span
                  ...
                  aria-hidden
                />
                <article className="card-lift rounded-2xl border border-[color-mix(in_srgb,var(--amila-nude-stone)_38%,transparent)] bg-white/75 p-6 shadow-[0_12px_40px_-18px_rgba(125,87,73,0.1)] sm:p-7 lg:p-8">
