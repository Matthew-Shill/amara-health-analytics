...
export function PrivacySecuritySection() {
  return (
    <SectionBackdropWide id="privacy-security" tone="warm">
      ...
      <Reveal>
        <div className="mt-16 rounded-3xl border border-[color-mix(in_srgb,var(--amila-nude-stone)_40%,transparent)] bg-white/60 p-7 shadow-[0_20px_50px_-24px_rgba(75,52,43,0.12)] sm:p-9 lg:p-10">
