      ...
      <div className="grid gap-10 lg:grid-cols-5 lg:gap-14">
        <Reveal delay={1} className="lg:col-span-3">
          <div className="rounded-3xl border border-[color-mix(in_srgb,var(--amila-nude-stone)_35%,transparent)] bg-white/60 p-7 shadow-[0_20px_50px_-24px_rgba(75,52,43,0.12)] lg:p-9">
            ...
            <p className="mt-6 border-t border-[color-mix(in_srgb,var(--amila-nude-stone)_30%,transparent)] pt-6 text-sm leading-relaxed text-[color-mix(in_srgb,var(--amila-espresso)_70%,white)]">
        ...
        <Reveal delay={2} className="lg:col-span-2">
          <p className="mb-4 text-xs font-semibold uppercase tracking-[var(--amila-tracking-wide)] text-smoked-teal">
          ...
          <ul className="flex flex-wrap gap-2.5">
            {ABOUT_CAPABILITIES.map((cap, i) => (
              <li
                key={cap}
                className="rounded-full border border-[color-mix(in_srgb,var(--amila-smoked-teal)_20%,transparent)] bg-gradient-to-br from-white to-[color-mix(in_srgb,var(--amila-pearl)_90%,white)] px-4 py-2.5 text-sm font-semibold text-espresso shadow-sm transition-transform hover:-translate-y-0.5"
