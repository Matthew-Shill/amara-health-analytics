...
import { AmilaIcon, WHO_WE_SERVE_SIZE_ICONS } from "@/components/ui/icons/AmilaIcon";
    ...
    <SectionBackdropWide tone="warm" motif>
      ...
      <Reveal delay={1}>
        <div className="growth-spectrum mt-14 lg:mt-16">
          ...
          >
            ...
            >
              <defs>
                <linearGradient id="growth-arc-gradient" x1="0%" y1="100%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="var(--amila-nude-stone)" stopOpacity="0.55" />
                  <stop offset="45%" stopColor="var(--amila-smoked-teal)" stopOpacity="0.75" />
                  <stop offset="100%" stopColor="var(--amila-espresso)" stopOpacity="0.85" />
                </linearGradient>
                <linearGradient id="growth-fill-gradient" x1="0%" y1="100%" x2="100%" y2="0%">
                  <stop offset="0%" stopColor="var(--amila-nude-stone)" stopOpacity="0.12" />
                  <stop offset="100%" stopColor="var(--amila-smoked-teal)" stopOpacity="0.18" />
                </linearGradient>
              </defs>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {isActive && (
                      <span
                        className="absolute inset-0 rounded-full ring-4 ring-[color-mix(in_srgb,var(--amila-smoked-teal)_25%,transparent)]"
                        aria-hidden
                      />
                    )}
                  </span>
                  <span
                    className={`absolute left-1/2 top-[calc(100%+0.65rem)] w-max max-w-[7.5rem] -translate-x-1/2 text-center font-headline text-xs font-semibold leading-tight transition-colors sm:max-w-none sm:text-sm ${
                      isActive ? "text-espresso" : "text-[color-mix(in_srgb,var(--amila-espresso)_62%,white)]"
                    }`}
                  >
                    {tier.shortLabel}
                  </span>
            ...
            <div
              className="pointer-events-none absolute bottom-0 left-0 right-0 flex justify-between px-1 text-[0.65rem] font-semibold uppercase tracking-[var(--amila-tracking-wide)] text-[color-mix(in_srgb,var(--amila-espresso)_48%,white)] sm:text-xs"
              aria-hidden
            >
              ...
              <button
                ...
                className={`rounded-full px-3.5 py-1.5 text-xs font-semibold transition-colors ${
                  i === activeIndex
                    ...
                    : "border border-[color-mix(in_srgb,var(--amila-nude-stone)_45%,transparent)] bg-white/70 text-espresso"
                }`}
              >
                {tier.shortLabel}
              </button>
      ...
      <Reveal delay={2}>
        <div
          ...
          className="glass-panel-strong relative mt-16 overflow-hidden rounded-[2rem] border border-[color-mix(in_srgb,var(--amila-nude-stone)_35%,transparent)] lg:mt-20"
        >
          <div
            className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full bg-[color-mix(in_srgb,var(--amila-smoked-teal)_18%,transparent)] blur-3xl"
            aria-hidden
          />
          <div
            className="pointer-events-none absolute -bottom-20 -left-12 h-56 w-56 rounded-full bg-[color-mix(in_srgb,var(--amila-nude-stone)_35%,transparent)] blur-3xl"
            aria-hidden
          />
          ...
          <div className="relative grid gap-8 p-7 sm:p-9 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center lg:gap-12 lg:p-11">
            <div>
              <div className="flex flex-wrap items-center gap-3">
                ...
                <span className="text-xs font-medium text-[color-mix(in_srgb,var(--amila-espresso)_55%,white)]">
              ...
              <p className="mt-4 text-base leading-relaxed text-[color-mix(in_srgb,var(--amila-espresso)_76%,white)]">
                {activeTier.description}
              </p>
            </div>

            <div className="relative rounded-2xl border border-[color-mix(in_srgb,var(--amila-smoked-teal)_22%,transparent)] bg-gradient-to-br from-[color-mix(in_srgb,var(--amila-smoked-teal)_10%,white)] via-white/80 to-[color-mix(in_srgb,var(--amila-nude-stone)_12%,white)] p-6 sm:p-7">
              <div className="flex items-start gap-4">
                <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-smoked-teal to-[color-mix(in_srgb,var(--amila-smoked-teal)_70%,var(--amila-espresso))] shadow-md">
                  <AmilaIcon
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-relaxed text-[color-mix(in_srgb,var(--amila-espresso)_78%,white)] sm:text-base">
                    {activeTier.help}
                  </p>
                </div>
              </div>
          ...
          <div className="relative border-t border-[color-mix(in_srgb,var(--amila-nude-stone)_35%,transparent)] px-7 py-4 sm:px-9 lg:px-11">
              ...
              {WHO_WE_SERVE_SIZES.map((tier, i) => (
                <button
                  ...
                  className={`h-1.5 flex-1 rounded-full transition-all duration-500 ${
                    i === activeIndex
                      ? "bg-gradient-to-r from-smoked-teal to-[color-mix(in_srgb,var(--amila-smoked-teal)_70%,var(--amila-espresso))]"
                      : i < activeIndex
                        ? "bg-[color-mix(in_srgb,var(--amila-smoked-teal)_45%,var(--amila-nude-stone))]"
                        : "bg-[color-mix(in_srgb,var(--amila-nude-stone)_55%,transparent)]"
                  }`}
                />
              ))}
            </div>
